...
export const meta: RouteMeta = {
  POST: {
    description: 'Registers a new customer support complaint or grievance. Requires a subject line and a detailed description, and returns a unique support ticket ID for future tracking.',
